...
NTSTATUS cMemory::WPM(PVOID lpBaseAddress, PVOID lpBuffer, ULONG nSize, PULONG lpNumberOfBytesWrited)
{
	return cApi->safe_write_mem(hProc, lpBaseAddress, lpBuffer, nSize, lpNumberOfBytesWrited);
}
